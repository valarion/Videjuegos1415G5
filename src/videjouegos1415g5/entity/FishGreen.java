...
public class FishGreen extends Enemy {
	
	private final String ANIMATION = "/enemies/fish_green.png"; 
	private final static int w = 16;
	private final static int h = 18;

	public FishGreen(GenerateObstacles obs, Map map, Bomberman player) {
...
public void render3d( GL2 gl, GLU glu ) {
	...
	gl.glPushMatrix();
	gl.glColor3d(1,0.7,0);
	gl.glTranslated(-r*0.9,r/4,r/10);
	float size=r/3f;
