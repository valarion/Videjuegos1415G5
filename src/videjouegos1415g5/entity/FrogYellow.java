...
public class FrogYellow extends Enemy {
	
	private final String ANIMATION = "/enemies/frog_yellow.png"; 
	private final static int w = 16;
	private final static int h = 18;

	public FrogYellow(GenerateObstacles obs, Map map, Bomberman player) {
