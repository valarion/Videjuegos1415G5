...
public class BalloonBlue extends Enemy {
	
	private final String ANIMATION = "/enemies/balloon_blue.png"; 
	private final static int w = 16;
	private final static int h = 18;

	public BalloonBlue(GenerateObstacles obs, Map map, Bomberman player) {
