...
public class CrocodileGreen extends Enemy {
	
	private final String ANIMATION = "/enemies/crocodile_green.png"; 
	private final static int w = 16;
	private final static int h = 18;

	public CrocodileGreen(GenerateObstacles obs, Map map, Bomberman player) {
