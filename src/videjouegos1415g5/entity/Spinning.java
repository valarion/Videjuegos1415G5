...
public class Spinning extends Enemy {
	...
	private final String ANIMATION = "/enemies/spinning.png"; 
	private final static int w = 16;
	private final static int h = 18;

	public Spinning(GenerateObstacles obs, Map map, Bomberman player) {
		...
		BufferedImage[] die = {ss.obtenerSprite(4*w*scale, 0, w*scale, h*scale),
