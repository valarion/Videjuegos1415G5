...
public class BalloonPurple extends Enemy {
	
	private final String ANIMATION = "/enemies/balloon_purple.png"; 
	private final static int w = 16;
	private final static int h = 18;

	public BalloonPurple(GenerateObstacles obs, Map map, Bomberman player) {
